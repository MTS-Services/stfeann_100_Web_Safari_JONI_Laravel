<x-frontend::layout>
    ...
    <section class="relative sm:w-full">
        <img src="{{ asset('frontend/images/Correr2.png') }}" alt="About Us Background" class="w-full lg:h-[450px] h-full object-cover ">
   ...
   <section class="flex justify-center items-center min-h-[697px] bg-white py-2 sm:py-2">
    <div class="w-full max-w-[1500px] flex flex-col md:flex-row items-center justify-center rounded-lg overflow-hidden">
        ...
        <div class="md:w-1/2 w-full flex flex-col mb-8 md:mb-16 justify-start items-center md:items-start p-6 sm:p-8 md:p-10 bg-gradient-to-br from-white to-gray-100">
            <h1 class="text-xl sm:text-2xl md:text-4xl text-black mb-4 md:mb-6 text-left">
                Tudo começou com uma ideia simples durante um treino
            </h1>
            <p class="text-base sm:text-lg md:text-xl text-black text-left">
                ...
                <br><br>
                A ideia surgiu entre conversas no pós-treino, com o corpo cansado mas a mente cheia de energia:
                "E se criássemos uma marca que realmente entendesse a linguagem do ginásio?"
                <br><br>
                Não queríamos apenas mais uma marca. Queríamos construir algo com identidade, com propósito, com garra.
                Começámos com esboços simples, a testar tecidos, a falar com pequenas oficinas de produção, a errar e a ajustar.
                Cada peça foi criada com atenção ao detalhe, pensando em quem dá tudo no treino — e também fora dele.
            </p>
        </div>
    </div>
</section>
