<x-frontend::layout>
    ...
    <section class="flex justify-center items-center min-h-[697px] bg-white py-2 sm:py-2">
        <div
            ...
            <!-- Content Side -->
            <div
                class="md:w-1/2 w-full flex flex-col mb-8 md:mb-16 justify-start items-center md:items-start p-6 sm:p-8 md:p-10 bg-gradient-to-br from-white to-gray-100">
                ...
                <p class="text-base sm:text-lg md:text-xl text-black text-left">
                    ...
                    e a ajustar.
                    Cada peça foi criada com atenção ao detalhe, pensando em quem dá tudo no treino — e também fora
                    dele.
                </p>
            </div>
        </div>
    ...
    <section class="flex justify-center items-center bg-white py-2 sm:py-2 sm:pb-20">
        <div
            ...
            <div
                class="md:w-1/2 w-full flex flex-col justify-start items-center md:items-start p-6 sm:p-8 bg-gradient-to-br  rounded-xl ">
