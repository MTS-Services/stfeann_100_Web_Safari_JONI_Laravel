<x-frontend::layout>
   ...
   <section class="flex justify-center items-center min-h-[697px] bg-white dark:bg-gray-900 py-2 sm:py-2">
    <div class="w-full max-w-[1500px] flex flex-col md:flex-row items-center justify-center rounded-lg overflow-hidden">
        ...
        <!-- Content Side -->
        <div class="md:w-1/2 w-full h-[300px] sm:h-[400px] md:h-[550px] px-4 lg:px-8 dark:bg-gray-900">
...
<section class="flex justify-center items-center bg-white dark:bg-gray-900 py-2 sm:py-2 sm:pb-20 ">
    ...
    <!-- Card 1 -->
    <div class="bg-gray-100 p-4 sm:p-6 rounded-xl shadow-md dark:bg-gray-900">
    ...
    <div class="bg-gray-100 p-4 sm:p-6 rounded-xl shadow-md dark:bg-gray-900">
        ...
        <div class="md:w-1/2 w-full flex flex-col justify-start items-center md:items-start p-6 sm:p-8 bg-gradient-to-br  rounded-xl dark:bg-gray-900">
