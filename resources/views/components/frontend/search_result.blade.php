...
<div class="bg-white  overflow-hidden relative group p-4 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col sm:flex-row gap-3">
    <!-- Image Section -->
    <div class="relative overflow-hidden w-full sm:w-2/5 rounded-lg">
    ...
    <div class="w-full sm:w-1/2 flex flex-col justify-between p-2 sm:p-4">
        <div>
            <h5 class="text-sm sm:text-xl font-bold text-gray-800 mb-1 line-clamp-1">{{ $product->name }}</h5>
            ...
            <div class="flex items-center space-x-1 mb-2">
                ...
                <span class="text-gray-600 text-xs">(4.0)</span>
            </div>

        </div>
        <!-- Description -->
        <p class="text-gray-600 text-xs sm:text-sm  line-clamp-3 mb-4">
            {{ $product->description }}
        </p>
