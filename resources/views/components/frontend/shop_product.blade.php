    ...
    <div class="lg:p-4 p-1">
        ...
        <div class="flex items-center mb-0">
         ...
         <div class="flex justify-between items-center mt-3">
            <h4 class="text-sm font-extrabold text-black">{{ $product->price }}€</h4>
            <button
                class="bg-red-500 text-white rounded-lg px-1 py-1 text-base font-semibold group-hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors flex items-center gap-2 shadow relative">
