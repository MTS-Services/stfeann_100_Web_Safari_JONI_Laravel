...
<div class="group relative overflow-hidden rounded-sm bg-white p-2 transition-shadow hover:shadow-md">
    ...
    <div class="p-1 lg:p-4">
        ...
        <div class="mt-3 flex items-center justify-between gap-2">
            ...
            <button type="button"
                class="flex items-center gap-1 rounded-lg bg-red-500 px-3 py-1.5 text-xs font-semibold text-white shadow transition-colors hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:px-3.5 sm:py-2 sm:text-sm md:px-4 md:py-2.5 md:text-base"
