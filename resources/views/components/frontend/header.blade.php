            ...
            <div class="flex items-center justify-between h-10">
                ...
                <div class="hidden md:flex items-center space-x-10">
                    ...
                    <a href="{{ route('f.about') }}"
                        class="group relative nav-link px-2 py-2 rounded-md lg:text-2xl xl:text-3xl font-bold transition-colors duration-300 ease-in-out {{ request()->routeIs('f.about') ? 'text-text-primary' : 'text-text-black hover:text-text-primary' }}">
                        Sobre nós
                        <span
                    ...
                    <form action="{{ route('f.products.search') }}" method="GET"
                        ...
                        <div class="flex items-stretch w-full">
                            ...
                            <input type="text" name="search" value="{{ Request::get('search') }}"
                                ...
                                class="lg:w-full md:full w-12 md:w-18 lg:h-full h-6 md:h-10 text-[12px] text-black sm:text-base md:px-2 md:py-4 sm:px-1 sm:px-3 sm:py-1 sm:py-2 rounded-l-md bg-white dark:bg-bg-dark border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition" />
