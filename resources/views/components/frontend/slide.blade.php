@props(['categories'])
 ...
 @foreach ($categories as $category)
        <!-- Slide -->
        <div class="swiper-slide overflow-hidden bg-white rounded-xl flex flex-col items-center border-2 border-gray-200 gap-2 h-auto transition-transform duration-500 group-hover:scale-110 relative p-2">
            <a href="javascript:void(0)" class="absolute inset-0 bg-transparent z-10"></a>
